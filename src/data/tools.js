...
export const TOOLS = [
  ...
  { href: "/education/signals-switches/", name: "Signals & Switches", cta: "Open reference", desc: "Digital electronics on a live bench: logic levels, clocks, serial data, HART FSK on the loop, diodes, transistors, and relays." }
];
